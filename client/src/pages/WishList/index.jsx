    ...
    <div className={cx("wrapper")}>
      ...
      <section className={cx("breadcrumbs")}>
        <div className={cx("row-title")}>
          <img src={images.heartIcon} alt="heart-icon" className={cx("icon")} />
                    ...
                    {wishlistData?.map((item, index) => (
                      ...
                      >
                        ...
                        <td className={cx("date", "column")}>
                          <span className={cx("name")}>{item?.location}</span>
                        </td>
                        <td className={cx("date", "column")}>
                        ...
                        <td className={cx("date", "column")}>
                          <div>
                            ...
                            >
                              <MenuItem
                                className={cx("text-item", "remove")}
                                onClick={handleDelete}
                              >
                                <div className={cx("row", "remove")}>
                                  <img
