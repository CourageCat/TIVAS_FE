...
export const updateBooking = async (axiosInstance, id, form) => {
    try {
        const res = await services.updateBooking(axiosInstance, id, form);
        return res;
    } catch (err) {
        console.log(err);
    }
...
export const getStatisticOnStage = async (axiosInstance, id) => {
    try {
        const res = await services.getStatisticOnStage(axiosInstance, id);
        return res;
    } catch (err) {
        console.log(err);
    }
