    ...
    return listBlog.map((item, index) => {
      return (
        <section key={index} className={cx("blog-item")}>
          <img className={cx("blog-img")} src={item.image} alt="Blog" />
            ...
            <div key={index}>
              <div className={cx("feedback")}>
                ...
                <div className={cx("content")}>
                  <h3 className={cx("heading")}>{item?.User?.username}</h3>
                  <div className={cx("review")}>
                    <div className={cx("rating")}>
                      ...
                      <p className={cx("text")}>{item?.content}</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className={cx("box")}>
            <Link to={`/projectdetail/${item.id}`}>
              ...
              <div className={cx("heart-bandle")}>
                <span className={cx("bandle")}>Top 10 Resort</span>
              </div>
