...
function Search() {
    ...
    const handleProjectName = () => {
        return navigate(`/search/type=project&value=${search}`);
    };

    const handleProjectLocation = () => {
        return navigate(`/search/type=location&value=${search}`);
    };
                                ...
                                {searchResult?.ProjectLocation?.length > 0 && (
                                    <div className={cx("box-search")}>
                                        <div className={cx("box-header")}>
                                            ...
                                            <span
                                                className={cx("brow")}
                                                onClick={handleProjectLocation}
                                            >
                                                See more
                                            </span>
                                        </div>
                                        <div className={cx("list-box")}>
                                            {searchResult?.ProjectLocation?.map(
                                                (item, index) => (
                                                    <Link
                                                        to={`projectdetail/${item?.id}`}
                                                    >
