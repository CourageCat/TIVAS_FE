          ...
          <div className={cx("info-detail")}>
            <div className={cx("top-content")}>
              <div className={cx("left")}>
                <h1 className={cx("title")}>{form?.form?.projectName}</h1>
                ...
                <div className={cx("location")}>
                  ...
                  <span className={cx("text")}>{form?.form?.location}</span>
                </div>
              </div>
            </div>
            ...
            <div className={cx("amenities")}>
              ...
              <div className={cx("list-amenities")}>
                <div className={cx("left-list")}>
                  {form?.form?.features?.slice(0, 3).map((item, index) => {
                    return (
                ...
                <div className={cx("right-list")}>
                  {form?.form?.features?.slice(3, 6).map((item, index) => {
                    return (
                      <div key={index} className={cx("item")}>
                        {item}
                      </div>
