...
function ActionProject({
  ...
  const handleSubmitNewStageOpenDateReservation = async (e) => {
    ...
    const form = {
      ...
      reservationDate:
        newReservationDate !== "" ? convertDate(newReservationDate) : null,
    };
    ...
    <div>
              ...
              <div className={cx("list")}>
                ...
                {status === 0 && (
                  ...
                  >
                    ...
                    <span className={cx("title")}>Open reservation</span>
                  </div>
                )}
                {status === 1 && (
                  <>
                    <div
                      className={cx("item", "open_booking")}
                    ...
                    >
                      ...
                      <span className={cx("title")}>Open booking</span>
                    </div>
                  </>
                )}
                {status === 2 && (
                  ...
                  >
                    ...
                    <span className={cx("title")}>Close booking</span>
                  </div>
                )}
                {status === 3 && (
                  <div
      ...
      <div className={cx("popup")}>
        ...
        >
          ...
          <DialogContent>
            ...
            >
              <FormControl sx={{ mt: 2, minWidth: 160 }}>
                <InputLabel htmlFor="typePriority">Type priority</InputLabel>
                <Select
                  autoFocus
          ...
          <DialogActions>
            <Button sx={{ fontSize: 13 }} onClick={handleClosePopupBook}>
              Close
            </Button>
            <Button sx={{ fontSize: 13 }} onClick={handleCloseBookingDate}>
              Submit
            </Button>
          </DialogActions>
        </Dialog>
            ...
            <div className={cx("list-popup")}>
              <div className={cx("input_popup")}>
                ...
                <input
                  ...
                  onChange={(e) => setNewReservationPrice(e.target.value)}
                  id="reservationPrice"
                />
              </div>
              <div className={cx("input_popup")}>
