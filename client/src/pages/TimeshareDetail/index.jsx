...
function TimeshareDetail() {
  ...
  useEffect(() => {
    if (message?.err === 1) {
      toast.custom(
        () => (
          <ToastNotify type="error" title="Error" desc={message?.message} />
        ),
        { duration: 2000 }
      );
      ...
      toast.custom(
        () => (
          <ToastNotify type="success" title="Success" desc={message?.message} />
        ),
        { duration: 2000 }
      );
    }
            ...
            <div className={cx("right-content")}>
              <div className={cx("booking-info")}>
                ...
                <div className={cx("note")}>
                  <p className={cx("text")}>
                    <span className={cx("bold")}>Attention: </span> Please read
                    the rules below carefully for better understanding before
                    participating
                  </p>
                </div>
                <button
                  ...
                  onClick={() => {
                    timeshareData?.saleStatus === 1 && setOpen(true);
                  }}
                >
                  {timeshareData?.saleStatus === 1 ? "Book Now" : "Not Open"}
                </button>
              </div>
            </div>
          </div>
      ...
      <>
        ...
        >
          ...
          <DialogContent dividers>
            <Booking handleClose={handleClose} setMessage={setMessage} />
          </DialogContent>
        </BootstrapDialog>
      </>
    </div>
