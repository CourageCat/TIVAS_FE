...
import styles from "./PurchasedFail.module.scss";
    ...
    return (
        <div className={cx("wrapper")}>
            <div className={cx("row")}>
                <h1 className={cx("title")}>Purchased Fail</h1>

                <Tippy
                    content="Show all timeshare you purchased fail"
                    placement="top"
                >
                    <img
                        className={cx("icon")}
...
export default HistoryPurchasedFail;
