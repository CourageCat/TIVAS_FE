                ...
                <thead className={cx("thead")}>
                  <tr>
                    ...
                    <th className={cx("sleep", "column")}>
                      <h4 className={cx("title")}>TypeRoom</h4>
                    </th>
                    <th className={cx("date", "column")}>
                      <h4 className={cx("title")}>User Name</h4>
                    </th>
                    <th className={cx("date", "column")}>
                      <h4 className={cx("title")}>Booking Status</h4>
                    </th>
                  </tr>
                </thead>
                    ...
                    return (
                      ...
                      >
                        <td className={cx("index", "column")}>
                          <span className={cx("num", "text")}>{index + 1}</span>
                        </td>
                        <td className={cx("project", "column")}>
                          <figure className={cx("infor")}>
                            <img
                              src={item?.projectThumbnailPathUrl}
                              alt="image_one"
                              className={cx("image")}
                            />
                        ...
                        <td className={cx("type-room", "column")}>
                        ...
                        <td className={cx("date", "column")}>
                          <span className={cx("name")}>
                            ...
                            {item?.bookingStatus === 1 && "Success"}
                            {item?.bookingStatus === -1 && "Failure"}
                          </span>
                        </td>
                      </tr>
                    );
