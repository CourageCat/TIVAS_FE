      ...
      return (
        <div key={index}>
          <div className={cx("box")}>
            <img src={item.pathUrl} alt="" className={cx("image")} />
          </div>
        </div>
      );
    });
            ...
            <div className={cx("row-wrapper")}>
              ...
              <div className={cx("guests", "row")}>
                <img
                  ...
                  alt="person-icon"
                />
                <div className={cx("text")}>{data.persons} Guests</div>
              </div>
              <div className={cx("area", "row")}>
                <img
                  ...
                  alt="area-icon"
                />
                <div className={cx("text")}>{data.size} Sq Ft</div>
              </div>
              ...
              <div className={cx("bedroom", "row")}>
                <img
                  ...
                  alt="bed-icon"
                />
                <div className={cx("text")}>{data.bedrooms} Room</div>
              </div>
            </div>
          </div>
